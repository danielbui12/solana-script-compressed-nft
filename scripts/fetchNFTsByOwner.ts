...
(async () => {
  ...
  printConsoleSeparator(`Getting all assets by owner 7fbPDP3jAbkEVf7QAAxhBKHcbfLPttPkyXJNNkv62Xvd...`);

  await connection
    .getAssetsByOwner({
      ownerAddress: "7fbPDP3jAbkEVf7QAAxhBKHcbfLPttPkyXJNNkv62Xvd",
    })
    .then(res => {
