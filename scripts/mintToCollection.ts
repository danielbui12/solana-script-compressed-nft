...
(async () => {
  ...
  */
  ...
  const mintToWallet = await mintCompressedNFT(
    connection,
    payer,
    new PublicKey("X5YZxkn4MmXqXwfJfmGvfucY2Ch217K59BURRVaHB5U"), // treeAddress,
    new PublicKey("9KD71uAN9HTPovRoYq7Zk7hJVacCQh7cPNXvw89Vsm1g"), // collectionMint,
    new PublicKey("Aq6wejA3BtQe7mjY18Fvj2gyiZc4qGUyYoTNjNUw8e33"),// collectionMetadataAccount,
    new PublicKey("5Cb8AEUVz72tVSKpMnkWV8xD5Qot7Tt7rKbJyLwiWjfL"), //collectionMasterEditionAccount,
    compressedNFTMetadata,
    // mint to this specific wallet (in this case, airdrop to `testWallet`)
    payer.publicKey,
  );

  console.dir(mintToWallet)
})();
